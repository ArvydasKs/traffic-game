...
public class GameRules {
    ...
    private static final double spawnProbability = 0.3; // sansas, kad atsiras automobilis
    private static final double emergencyCarProbability = 0.1; // sansas, kad atsirades automobilis bus avarinis
